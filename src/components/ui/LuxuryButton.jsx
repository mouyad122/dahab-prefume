...
export default function LuxuryButton({
  ...
  const variantClasses = {
    ...
    whatsapp: 'bg-[linear-gradient(135deg,#25D366_0%,#128C7E_100%)] text-white border border-[#25D366]/50 shadow-[0_4px_20px_rgba(37,211,102,0.25)] hover:-translate-y-[2px] hover:shadow-[0_8px_25px_rgba(37,211,102,0.35)] active:translate-y-0 active:scale-[0.98]',
